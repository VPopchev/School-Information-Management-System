...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\MarkType' => function () {
    return ($this->privates['App\Form\MarkType'] ?? $this->privates['App\Form\MarkType'] = new \App\Form\MarkType());
}, 'App\\Form\\SpecialtyType' => function () {
    return ($this->privates['App\Form\SpecialtyType'] ?? $this->privates['App\Form\SpecialtyType'] = new \App\Form\SpecialtyType());

...
$a->setNamespace('sf_orm_default_a81dfff713dc2fad3cfb9eb38711b240070c9f89e1c4c2bda2fd02df1c62766c');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_a81dfff713dc2fad3cfb9eb38711b240070c9f89e1c4c2bda2fd02df1c62766c');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_a81dfff713dc2fad3cfb9eb38711b240070c9f89e1c4c2bda2fd02df1c62766c');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\MarkRepository' => function () {
    return ($this->privates['App\Repository\MarkRepository'] ?? $this->load(__DIR__.'/getMarkRepositoryService.php'));
...
}, 'App\\Repository\\SpecialtyRepository' => function () {
    return ($this->privates['App\Repository\SpecialtyRepository'] ?? $this->load(__DIR__.'/getSpecialtyRepositoryService.php'));
}, 'App\\Repository\\SubjectRepository' => function () {
    return ($this->privates['App\Repository\SubjectRepository'] ?? $this->load(__DIR__.'/getSubjectRepositoryService.php'));
